...
<section class="main__block">
  ...
  <p><!-- react-text: 15 -->The panel is divided primarily of <!-- /react-text --><code>panel__header</code><!-- react-text: 17 -->, <!-- /react-text --><code>panel__body</code><!-- react-text: 19 --> and <!-- /react-text --><code>panel__footer</code><!-- react-text: 21 -->as demonstrated in the following example:<!-- /react-text --></p>
  <section class="demos">
...
&lt;/div&gt;
  ...
  <h3>Actionable buttons triggering a contextual menu</h3>
...
&lt;/div&gt;
  ...
  <h3>Panel header title with dropdown contextual menu</h3>
  <p>There might be scenarios where you'd want to update something in the body in the panel by selecting a set of options from the title. Here's samples of how it would work.</p>
  <section class="demos">
    <div class="demos__header">
      <h4>Example</h4><a class="code__action"><span class="icon icon__size--medium icon__color--action"><svg height="24px" viewbox="0 0 24 24" width="24px">
      <g fill="inherit">
...
&lt;/div&gt;
  ...
  <p>Here is with the menu expanded:</p>
  <section class="demos">
    <div class="demos__header">
      <h4>Example</h4><a class="code__action"><span class="icon icon__size--medium icon__color--action"><svg height="24px" viewbox="0 0 24 24" width="24px">
      <g fill="inherit">
        ...
        <div class="panel">
          <div class="panel__header">
            ...
            <div class="panel__title">
              <div class="header__select">
                <h3>Visualizations</h3>
                <div class="header__trigger context-menu__container">
                  <span class="icon icon__size--medium icon__color--ui"><svg height="24px" viewbox="0 0 24 24" width="24px">
                    <g fill="inherit">
                      <path d="M7.20710678,10 L16.7928932,10 C17.0690356,10 17.2928932,10.2238576 17.2928932,10.5 C17.2928932,10.6326082 17.2402148,10.7597852 17.1464466,10.8535534 L12.3535534,15.6464466 C12.1582912,15.8417088 11.8417088,15.8417088 11.6464466,15.6464466 L6.85355339,10.8535534 C6.65829124,10.6582912 6.65829124,10.3417088 6.85355339,10.1464466 C6.94732158,10.0526784 7.07449854,10 7.20710678,10 Z"></path>
                    </g></svg></span>
                  <ul class="context-menu cmjs context-menu--right">
                    <li class="context-menu__item">
                      <a href="">Edit</a>
                    </li>
                    <li class="context-menu__item">
...
<section class="main__block">
  <h2>Panel with no styles</h2>
  <p>Panels are the core component of the chunk of content you'll be using on our apps. Those could be tables, lists, graphs, etc. There will be circumstances where you won't want to to show panels as panels but rather as simply chunks of content. Structurally they are composed of the same elements, but slightly different depending of the context.</p>
  <section class="demos">
    <div class="demos__header">
      <h4>Example</h4><a class="code__action"><span class="icon icon__size--medium icon__color--action"><svg height="24px" viewbox="0 0 24 24" width="24px">
      <g fill="inherit">
    ...
    <div class="demos__body">
        ...
        <div class="panel panel__no-styles">
          <div class="panel__header">
            <div class="panel__actions-item">
              <span class="icon icon__size--medium icon__color--ui"><svg height="24px" viewbox="0 0 24 24" width="24px">
                <g fill="inherit">
...
<section class="main__block">
  <h2>Panel with header buttons</h2>
  <p>There might be scenarios where you'd need to have buttons in the header. Example could be a set of segmented navigation or tab navigation or if you need to send form information.</p>
  <section class="demos">
    <div class="demos__header">
      <h4>Example</h4><a class="code__action"><span class="icon icon__size--medium icon__color--action"><svg height="24px" viewbox="0 0 24 24" width="24px">
      <g fill="inherit">
        ...
        <div class="panel">
          <div class="panel__header">
            ...
            <div class="panel__actions-buttons">
              <a class="btn btn__neutral btn__neutral--outline btn__size-s" href="#">Settings</a><a class="btn btn__neutral btn__neutral--outline btn__size-s" href="#">Activity</a><a class="btn btn__neutral btn__neutral--outline btn__size-s" href="#">Trends</a>
            </div>
          </div>
          <div class="panel__body">
            <div class="grid grid__gutter grid__1-2">
...
&lt;div class=&quot;panel&quot;&gt;
  &lt;div class=&quot;panel__header&quot;&gt;
    ...
    &lt;/div&gt;
    &lt;div class=&quot;panel__actions-buttons&quot;&gt;
      &lt;a class=&quot;btn btn__neutral btn__neutral--outline btn__size-s&quot; href=&quot;#&quot;&gt;Settings&lt;/a&gt;
      &lt;a class=&quot;btn btn__neutral btn__neutral--outline btn__size-s&quot; href=&quot;#&quot;&gt;Activity&lt;/a&gt;
      &lt;a class=&quot;btn btn__neutral btn__neutral--outline btn__size-s&quot; href=&quot;#&quot;&gt;Trends&lt;/a&gt;
    &lt;/div&gt;
  &lt;/div&gt;
  &lt;div class=&quot;panel__body&quot;&gt;
    &lt;div class=&quot;grid grid__gutter grid__1-2&quot;&gt;
